...
<head>
    ...
    <link rel="stylesheet" href="eliminarEstilo.css">
...
<body>
    ...
    <div class="cuerpo">
        ...
        <div class="row">
            <form action="MetodoEliminar.php" method="get">
                ...
                for($i=0;$i<$cantidad;$i++){
                    ...
                    echo "<td>";
                    echo "<input type='checkbox' id='$clave' value='$clave' name='registrosSeleccionados[]'>";
                    echo "<label for='$clave'>Eliminar</label>";
                    echo "</td>";
